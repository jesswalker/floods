...
####Steps  
  ...
  - Gages assessed for length of data record, data type
    - Gage record has to include at least 10 years of data after 1984
...
# Only get gages with >= 10 years of data after 1984
# 'Difftime' reported in days
g.sub <- subset(g, end_date > "1994-01-01" & time_active > 3650)
