...
```
First of 3 scripts necessary to recreate results in "Integrating stream gage data and Landsat imagery to complete time-series of surface water extents in Central Valley, California" 

####Script workflow 
  - Load packages: data.table, tidyverse
  - Retrieve datasets from ScienceBase: Joint Research Commission Monthly Water History v1.0 (JRC) and Dynamic Surface Water Extent (DSWE) 1984-2015 monthly composites _(currently stored in a Google Drive placeholder)_
...
####Output
  - Consolidated file of monthly stream gage, JRC, and DSWE values written to **`r file.path(path.data, file.out)`**.  This file will be accessed by **2_calculate_correlations.Rmd**
