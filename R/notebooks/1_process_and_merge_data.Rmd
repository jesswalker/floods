---
title: "Process and merge stream gage data with JRC and DSWE imagery in California's Central Valley"
fontsize: 8
...
# - Output file is written to path.out
path.out <-  "E:/projects/place/data"
file.out <- paste0("merged_imagery_gage_", nodata_threshold, "pct.RData")
...
####User actions required
  - Specify valid local directory for output file

####Inputs
  - *All data are retrieved from online sources*
...
####Output
  - Consolidated file of monthly stream gage, JRC, and DSWE values written to **`r file.path(path.out, file.out)`**
