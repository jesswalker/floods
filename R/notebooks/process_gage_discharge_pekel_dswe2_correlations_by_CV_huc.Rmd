...
# Calculate correlations for reduced data set (missing water values are not yet interpolated)
...
pk_ds_sg.cor$water <- ifelse(is.na(pk_ds_sg.cor$water), pk_ds_sg.cor$mean_va * pk_ds_sg.cor$m + pk_ds_sg.cor$b, pk_ds_sg.cor$water)
