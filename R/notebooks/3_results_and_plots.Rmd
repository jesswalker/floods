...
# These values identify which existing file to load
...
# - Input file is read from path.data/data/
# - Shapefile is read to path.data/R/shp 
...
# Set path to shapefile directory; create if non-existent
...
####Inputs
  ...
  - User input in script necessary to change directories from default settings
