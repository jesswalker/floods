...
# Take ALL correlations for rows where imagery HUC = stream gage HUC
pk_ds_sg.cor.1 <- pk_ds_sg.cor.all %>% 
  filter(huc8.img == huc8.sg)

# Take ONLY the external stream gage with the highest correlation to each imagery HUC
