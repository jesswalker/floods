...
file.in <- file.path(path.data, paste0("CV_dswe_jrc_data_", nodata_threshold, "_pct_nodata_merged.RData"))
file.out <- paste0("CV_dswe_jrc_data_", nodata_threshold, "_pct_nodata_correlations.RData")
...
#save(cor.all.max, cor.huc.max, pk_ds, ds_sg, pk_ds_sg.int, file = file.path(path.data, file.out))
