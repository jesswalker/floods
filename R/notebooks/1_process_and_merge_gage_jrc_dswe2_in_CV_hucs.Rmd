...
file.out <- paste0("CV_dswe_jrc_data_", nodata_threshold, "_pct_nodata_merged.RData")


```
####Steps  

  - JRC/Pekel and DSWE 2.0 monthly composites within all Central Valley HUCs retrieved from online Google Drive account
